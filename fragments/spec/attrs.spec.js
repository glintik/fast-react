...
fdescribe("Attrs", () => {
    ...
    it('simple with const', () => {
        new Test()
            ...
            .update(<div title={Title2} id="Id1" className="Class1" data-name={Name2}
                         onClick={onClick2} onmousedown={onMouseDown2}></div>, `<div id="Id1" class="Class1" title="Title2" data-name="Name2"></div>`, {onclick: onClick2, onmousedown: onMouseDown2})
    ...
    it('spread', () => {
        ...
        new Test()
            ...
            `<div title="Title2" id="Id1" class="Class2" rel="Rel2" data-name="Name2"></div>`, {onclick: null, onmousedown: null})
    });
